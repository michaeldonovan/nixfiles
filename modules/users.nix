...
let
  ssh-keys = [
    ...
    "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBFAGvLwIvzwWo48sYl8QBLmPxfabxK3JK9gZMfNMIE68iyw0eAXjiiuoH7/A6pq3jrh/PXmlxwwwhUtGDmASACE="
  ];
in
{
  users.users.michael = {
